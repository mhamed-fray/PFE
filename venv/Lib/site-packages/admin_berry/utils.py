...
def send_registration_email_to_admin(user_email):
    ...
    message = f'A new user with email {user_email} has registered on your website.'
    recipient_email = 'fraymhamed8@gmail.com'  # Replace with your admin's email
    sender_email = settings.EMAIL_HOST_USER  # Use the sender's email from settings
