...
<header class="pc-header">
  <div class="m-header">
    ...
    {% endif %}
      ...
      <img src="{% static 'assets/images/zai.jpeg' %}" alt="" class="logo logo-lg" width="80  " height="70" viewBox="0 0 22 22" fill="none" style="border-radius: 50%;">
    </a>
    <!-- ======= Menu collapse Icon ===== -->
    <div class="pc-h-item">
      <a href="#" class="pc-head-link head-link-secondary m-1" id="sidebar-hide">
        ...
        <div class="dropdown-header px-0 text-wrap header-notification-scroll position-relative"
          ...
          <div class="list-group list-group-flush w-100">
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="{% static 'assets/images/user/avatar-1.jpg' %}" alt="user-image" class="user-avtar" />
                </div>
                <div class="flex-grow-1 ms-1">
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="{% static 'assets/images/user/avatar-3.jpg' %}" alt="user-image" class="user-avtar" />
                </div>
                <div class="flex-grow-1 ms-1">
